...
import com.flatcode.simpleadvancedapps.utils.loadImageWithBlur
...
class CharacterAdapter : BaseAdapter<CharacterModel, Int, ItemCharacterBinding>() {
    ...
    override fun bind(binding: ItemCharacterBinding, item: CharacterModel) {
        binding.image.loadImageWithBlur(item.image, blurTarget = binding.imageBlur)
        ...
        binding.tvType.text = item.type.ifEmpty { DATA.UNKNOWN }
