...
class MainInfoViewModel : ViewModel() {
    ...
    private val dataInfo: ArrayList<MainInfo>
        get() {
            ...
            arrayList.add(MainInfo(DATA.VALORANT, S[6], S2[6], S3[6], S4[6], S5[6]))
            arrayList.add(MainInfo(DATA.POP, S[7], S2[7], S3[7], S4[7], S5[7]))
            arrayList.add(MainInfo(DATA.MOVIE, S[8], S2[8], S3[8], S4[8], S5[8]))
            arrayList.add(MainInfo(DATA.STOCK_MARKET, S[9], S2[9], S3[9], S4[9], S5[9]))
            arrayList.add(MainInfo(DATA.NEWS, S[10], S2[10], S3[10], S4[10], S5[10]))
            arrayList.add(MainInfo(DATA.RICK_AND_MORTY, S[11], S2[11], S3[11], S4[11], S5[11]))
            arrayList.add(MainInfo(DATA.WEATHER, S[12], S2[12], S3[12], S4[12], S5[12]))
            arrayList.add(MainInfo(DATA.POKE, S[13], S2[13], S3[13], S4[13], S5[13]))
            arrayList.add(MainInfo(DATA.TODO_NOTE, S[14], S2[14], S3[14], S4[14], S5[14]))
            return arrayList
        }
}