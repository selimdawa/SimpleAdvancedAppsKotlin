...
class MainViewModel : ViewModel() {
    ...
    private val data: ArrayList<Main>
        get() {
            ...
            arrayList.add(Main(R.drawable.ic_feed, DATA.NEWS, I[10], CLASS.I10))
            arrayList.add(Main(R.drawable.ic_child, DATA.RICK_AND_MORTY, I[11], CLASS.I11))
            arrayList.add(Main(R.drawable.ic_nights, DATA.WEATHER, I[12], CLASS.I12))
            arrayList.add(Main(R.drawable.ic_gamepad, DATA.POKE, I[13], CLASS.I13))
            arrayList.add(Main(R.drawable.ic_note, DATA.TODO_NOTE, I[14], CLASS.I14))
            return arrayList
        }
}